...
#include "K2BeamNode_ApiRequest_StellarFederationAddUniqueItem.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_StellarFederationAddUniqueItem"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /AddUniqueItem  of the StellarFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREAL2DDUNGEONMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_StellarFederationAddUniqueItem : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
