...
#include "K2BeamNode_ApiRequest_StellarFederationGenerateRealmAccount.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_StellarFederationGenerateRealmAccount"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GenerateRealmAccount  of the StellarFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREAL2DDUNGEONMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_StellarFederationGenerateRealmAccount : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
