...
#include "K2BeamNode_ApiRequest_StellarFederationGetListings.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_StellarFederationGetListings"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /GetListings  of the StellarFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREAL2DDUNGEONMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_StellarFederationGetListings : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
