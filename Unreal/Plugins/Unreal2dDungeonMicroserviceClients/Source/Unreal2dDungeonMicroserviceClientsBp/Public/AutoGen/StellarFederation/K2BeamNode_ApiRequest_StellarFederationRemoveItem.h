...
#include "K2BeamNode_ApiRequest_StellarFederationRemoveItem.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_StellarFederationRemoveItem"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /RemoveItem  of the StellarFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREAL2DDUNGEONMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_StellarFederationRemoveItem : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
