...
#include "K2BeamNode_ApiRequest_StellarFederationUpdateCurrency.generated.h"

#define LOCTEXT_NAMESPACE "K2BeamNode_ApiRequest_StellarFederationUpdateCurrency"

/**
* This is the code-gen'ed declaration for the Beam Flow's Endpoint: Post /UpdateCurrency  of the StellarFederation Service. 
*/
UCLASS(meta=(BeamFlow))
class UNREAL2DDUNGEONMICROSERVICECLIENTSBP_API UK2BeamNode_ApiRequest_StellarFederationUpdateCurrency : public UK2BeamNode_ApiRequest
{
	GENERATED_BODY()
