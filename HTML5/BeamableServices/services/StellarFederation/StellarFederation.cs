...
using ICommerceApi = Beamable.Common.Api.Commerce.ICommerceApi;
...
namespace Beamable.StellarFederation
{
	...
	public partial class StellarFederation : Microservice, IFederatedInventory<StellarWeb3Identity>
	{
		...
		[ClientCallable]
		public async Promise PurchaseBall(string purchaseId)
		{
			try
			{
				...
				BeamableLogger.Log($"Purchased ball Successful: {purchaseId}");
			}
			catch (Exception e)
			{
