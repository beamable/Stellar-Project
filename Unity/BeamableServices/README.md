...
│   ├── StellarFederationCommon/     # Shared types (netstandard2.1, Unity-compatible)
...
Read more on the [Content System](https://help.beamable.com/Unity-Latest/unity/user-reference/beamable-services/profile-storage/content/content-overview/)
...
In Unity, use the Content Manager to create instances:

1. Open **Window > Beamable > Content Manager**
2. Click **Create Content**
3. Select your custom content type (e.g., "items.weapon")
4. Set the content properties in the inspector
5. **Publish** to save changes to the Beamable backend

Content is stored as JSON in `.beamable/content/<PROJECT_ID>/global/`.
...
1. **Development**: Create/edit content in Unity Content Manager
...
1. Create test content in Unity Content Manager
2. Run microservice locally: `dotnet beam services run`
3. In Unity, grant test item to player
...
- [Beamable SDK 3.0 Content System](https://beamable.com/blog/beamable-unity-sdk-3-0-a-new-era-of-content-management-and-developer-experience)
...
- [Beamable Documentation](https://help.beamable.com/Unity-Latest/)
